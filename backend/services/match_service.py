...
class MatchService:
    ...
    def match_resume_to_job(self, user_id, data):
        ...
        match_doc = {
            ...
            "ml_predicted_score": match_result["ml_predicted_score"],
            "ml_quality": match_result["ml_quality"],
            "rule_based_score": match_result["rule_based_score"],
            "ai_enhanced_score": match_result["ai_enhanced_score"],
    ...
    def get_match_by_id(self, match_id):
        ...
        return {
            "match": {
                ...
                "semantic_similarity": m.get("semantic_similarity", 0),
                "ml_predicted_score": m.get("ml_predicted_score"),
                "ml_quality": m.get("ml_quality"),
                "rule_based_score": m.get("rule_based_score", 0),
                "ai_enhanced_score": m.get("ai_enhanced_score", 0),
                "matched_skills": m.get("matched_skills", []),
                "missing_skills": m.get("missing_skills", []),
